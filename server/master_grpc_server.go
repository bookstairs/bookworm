...
func (ms *MasterServer) SendHeartbeat(stream master_pb.Seaweed_SendHeartbeatServer) error {
	...
	for {
		...
		if dn == nil {
			// Skip delta heartbeat for volume server versions  better than 3.28 https://github.com/bookstairs/bookworm/pull/3630
			if heartbeat.Ip == "" {
				continue
